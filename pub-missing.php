...
if(isset($_POST['publish'])) {
  ...
  $date=mysqli_real_escape_string($conn, $_POST['date']);
    ...
    $insert_query = "INSERT INTO pub_missing (user_phone, user_name,user_city, anim_name,anim_type, anim_race,anim_gender, user_email, anim_image1, date, user_id) 
                    VALUES ('$user_phone', '$user_name','$user_city','$anim_name' ,'$anim_type', '$anim_race','$anim_gender', '$email','{$anim_images[0]}','$date','$user_id')";
      
    if(mysqli_query($conn, $insert_query)) {
        $_SESSION['pub_message'] = "Annonce published successfully.";
...
<section class="container-form">
    <h3 class="title-info">Annonce Request Missing Form</h3>
...
?>
          <div class="partition">
            <div class="parrtion-info">
                <h5>please enter your missing pet information </h5>
            ...
            <div class="options">
            <h5>enter your missing pet type </h5>
                <div class="check">
...
<div>
<h5>enter your missing pet gender </h5>
...
<div>
            ...
            <div class="miss-time">
           <h5>enter the date of tour last seen pet :</h5>
            <input type="date"  name="date" class="time" required></div>
            <h5>please select 3 images of your missing </h5>
