...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      if(isset($_SESSION['user_id'])) {
      ...
      }else{ echo '<div class="pro" onclick="window.location.href=\'signin-signup.php">';}
        ...
        echo '<div>';
        if(isset($_SESSION['user_id'])) {
        echo '<a href="host-card.php?host_id='.$row['host_id'].'">Host</a>'; 
       }else{
        echo '<a href="signin-sifnup.php">Host</a>'; 
      }
