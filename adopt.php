...
if(isset($_POST['submit'])){
    ...
    $sql = "(SELECT anim_name, anim_type, anim_race FROM pub_adoption WHERE anim_name = '$search' OR anim_type = '$search' OR anim_race = '$search')
    UNION
   (SELECT anim_name, anim_type, anim_race FROM pub_missing WHERE anim_name = '$search' OR anim_type = '$search' OR anim_race = '$search')
    UNION
   (SELECT anim_name, anim_type, anim_race FROM pub_host WHERE anim_name = '$search' OR anim_type = '$search' OR anim_race = '$search')";
    ...
    <header>
        <div class="header-main">
           ...
           if(!isset($_SESSION['user_id'])) {
            ...
            echo ' <ul>' ;
            echo ' <a  href="#pub-adoption.php" onclick="window.location.href=\'signin-signup.php\';"><li>ADOPTION</li></a>' ;
            echo ' <a  href="#pub-hosting.php" onclick="window.location.href=\'signin-signup.php\';"><li>HOSTING</li></a>' ;
            echo ' <a  href="#pub-missing.php" onclick="window.location.href=\'signin-signup.php\';"><li>MISSING</li></a>' ;
            echo ' </ul> ' ;
          }
          ?>
        </div>
