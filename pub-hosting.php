...
if(isset($_POST['publish'])) {
    ...
    $user_city = mysqli_real_escape_string($conn, $row['user_city']);
    ...
    $insert_query = "INSERT INTO pub_host (user_phone, user_name,  anim_type, anim_race,anim_gender, user_email, anim_description, user_city, anim_image1, anim_image2, anim_image3, user_id , price , delay, date) 
                    VALUES ('$user_phone', '$user_name', '$anim_type', '$anim_race','$anim_gender', '$email', '$anim_description','$user_city', '{$anim_images[0]}', '{$anim_images[1]}', '{$anim_images[2]}',  '$user_id', '$price', '$delay', '$date')";
...
<select class="animals" name="anim_gender">
    ...
    <option id="option2" value="female">Female</option>
            ...
            <textarea name="anim_description" class="description" cols="80" rows="10" placeholder="enter your animal description , needs  "></textarea>
           <div class="time-item">
           <h5>enter the day of <br>hosting  :</h5>
            <input type="date"  name="date" class="time" required>
            <h5>enter duration of <br> hosting :</h5>
            <input type="text" name="delay" class="time" placeholder="enter  duration " required>
            <h5>enter the offred  <br> price :</h5>
            <input type="text" name="price" class="time" placeholder="enter price  " required>
            </div>
